...
use App\Http\Controllers\Admin\{UserController, AuditLogController};
...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('must.change.password')->group(function () {
        ...
        Route::prefix('admin')->name('admin.')->group(function () {
            ...
            // Territories — all names become admin.territories.*
            ...
            Route::patch('territories/{territory}/toggle',     [TerritoryController::class, 'toggle'])->name('territories.toggle');
            Route::delete('territories/{territory}',           [TerritoryController::class, 'destroy'])->name('territories.destroy');
            Route::get('territories/districts',                [TerritoryController::class, 'getDistricts'])->name('territories.districts');

            // Products & Pricing — all names become admin.products.*
            ...
            // Audit Logs — name becomes admin.audit-logs.index
